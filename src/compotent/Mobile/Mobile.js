...
// const baseURL = "http://localhost/buy_tech/api/Products/";



export default function Mobile() {
  const [api, setApi] = useState([]);
  const { category_id, setId} = useParams();

const show = async () =>{
    await axios.get(`http://localhost/buy_tech/api/Products/1`).then((response) => {
    ...
    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mt-4">
      ...
      <Link class="custom-block custom-block-overlay"  onClick={(e) => {
        ...
        <a href="detail-page.html" class="custom-block-image-wrap">
          <img
            src={'http://localhost/buy_tech/public/images/product/' + mobile.image}
